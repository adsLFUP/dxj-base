...
@Controller
@RequestMapping("/ReservePart")
public class ReservePartController  {
...
//	}
	@RequestMapping(value = "/materialTypeList", method = RequestMethod.GET)
	public String materialTypeList(Model model, Integer offset, Integer limit) {
		LOG.info("invoke----------/user/list");

		return "material/base/materialTypeList";
	}
